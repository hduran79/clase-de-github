...
# Áreas de trabajo
***Working Directory:*** Es donde se trabaja con los archivos locales.

***Staging Area:*** Donde agregan los archivos para subirlos al repository.

***Repository:*** Repositorio de archivos.
